...
.. |docs| image:: https://readthedocs.org/projects/docs/badge/?version=latest
   ...
   :scale: 100%
   :target: https://golang-formula.readthedocs.io/en/latest/?badge=latest
...
#. Use the
   :ref:`provided page golang <saltstack_formulas_rst_page_golang>`
...
SaltStack-Formulas' RST page golang
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. _saltstack_formulas_rst_page_golang

Use the following golang when creating a new page.
